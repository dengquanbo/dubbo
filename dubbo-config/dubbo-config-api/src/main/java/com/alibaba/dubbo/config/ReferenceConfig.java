...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
            ...
            if (!ReferenceConfig.this.destroyed) {
                ...
                try {
                    ReferenceConfig.this.destroy();
                        ...
                        logger.warn("Unexpected err when destroy invoker of ReferenceConfig(" + url + ") in finalize
                        method!", t);
                }
                */
            }
    ...
    private static void checkAndConvertImplicitConfig(MethodConfig method, Map<String, String> map, Map<Object,
            Object> attributes) {
        ...
        if (onInvokeMethod != null && onInvokeMethod instanceof String) {
            attributes.put(onInvokeMethodKey, getMethodByName(method.getOninvoke().getClass(),
                    onInvokeMethod.toString()));
        }
    }
    ...
    private T createProxy(Map<String, String> map) {
        ...
        if (isJvmRefer) {
            // 创建服务引用 URL 对象
            URL url =
                    new URL(Constants.LOCAL_PROTOCOL, NetUtils.LOCALHOST, 0, interfaceClass.getName()).addParameters(map);
            // 引用服务，返回 Invoker 对象
